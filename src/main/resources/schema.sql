...
friends, reviews, review_likes, feeds;
...
CONSTRAINT "like_review_fk" FOREIGN KEY (review_id) REFERENCES reviews,
CONSTRAINT "like_user_review_fk" FOREIGN KEY (user_id) REFERENCES users,
CONSTRAINT "review_likes_pk" PRIMARY KEY (review_id, user_id, review_like)
);

CREATE TABLE IF NOT EXISTS feeds (
feed_id integer GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
user_id integer NOT NULL,
entiti_id integer NOT NULL,
